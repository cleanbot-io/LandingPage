  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white">
        <h1 className="text-4xl px-10 py-20 mt-10 mb-10">
          Explore our housekeeping subscriptions.
        </h1>

        <div className="flex overflow-x-auto space-x-6 mx-5 py-10 px-4 sm:px-0 scrollbar-hide justify-center">
      ...
      <h1 className="text-5xl pt-20 pl-20 sm:text-8x1 font-bold dark:text-white text-black tracking-tight">
        Additional {""}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 pt-20 mb-10 mx-10">
        <div className="h-46 bg-teal-300 dark:bg-slate-800 p-6 rounded-lg drop-shadow-xl overflow-hidden">
          <h2 className="text-2xl text-white dark:bg-slate-800 font-semibold p-5">
            Fridge
          </h2>
        ...
        <div className="h-46 bg-teal-300 dark:bg-slate-800 p-6 rounded-lg drop-shadow-xl overflow-hidden">
          <h2 className="text-2xl text-white font-semibold dark:bg-slate-800 p-5">
            Closet
          </h2>
          <p className="text-3xl text-white font-semibold mt-4">
      ...
      <h1 className="flex my-20 px-10 text-4xl justify-center">
        Order a turndown service and get a free desert on us
      </h1>
